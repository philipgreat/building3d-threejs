...
THREEx.ProceduralCity	= function(){
	...
	for( var i = 0; i < 2000; i ++ ){
		...
		// put a random scale
		buildingMesh.scale.x	= 10// Math.random() * Math.random() * Math.random() * Math.random() * 50 + 10;
		buildingMesh.scale.y	= 60* Math.random() //(Math.random() * Math.random() * Math.random() * buildingMesh.scale.x) * 8 + 8;
